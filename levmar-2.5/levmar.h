...
extern int dlevmar_der(
      void (*func)(double *p, double *hx, int m, int n, double *adata),
      void (*jacf)(double *p, double *j, int m, int n, double *adata),
...
extern int dlevmar_blic_der(
      ...
      int itmax, double opts[4], double info[LM_INFO_SZ], double *work, double *covar, double *adata);

extern int dlevmar_blic_dif(
      void (*func)(double *p, double *hx, int m, int n, double *adata),
      double *p, double *x, int m, int n, double *lb, double *ub, double *C, double *d, int k2,
      int itmax, double opts[5], double info[LM_INFO_SZ], double *work, double *covar, double *adata);
...
extern int slevmar_der(
      void (*func)(float *p, float *hx, int m, int n, double *adata),
      void (*jacf)(float *p, float *j, int m, int n, double *adata),
...
extern int slevmar_blic_der(
      ...
      int itmax, float opts[4], float info[LM_INFO_SZ], float *work, float *covar, double *adata);

extern int slevmar_blic_dif(
      void (*func)(float *p, float *hx, int m, int n, double *adata),
      float *p, float *x, int m, int n, float *lb, float *ub, float *C, float *d, int k2,
      int itmax, float opts[5], float info[LM_INFO_SZ], float *work, float *covar, double *adata);
...
extern void dlevmar_chkjac(
    void (*func)(double *p, double *hx, int m, int n, double *adata),
    void (*jacf)(double *p, double *j, int m, int n, double *adata),
    double *p, int m, int n, double *adata, double *err);
#endif /* LM_DBL_PREC */
...
extern void slevmar_chkjac(
    void (*func)(float *p, float *hx, int m, int n, double *adata),
    void (*jacf)(float *p, float *j, int m, int n, double *adata),
    float *p, int m, int n, double *adata, float *err);
#endif /* LM_SNGL_PREC */
...
extern double dlevmar_R2(void (*func)(double *p, double *hx, int m, int n, double *adata), double *p, double *x, int m, int n, double *adata);
...
extern float slevmar_R2(void (*func)(float *p, float *hx, int m, int n, double *adata), float *p, float *x, int m, int n, double *adata);
#endif /* LM_SNGL_PREC */
