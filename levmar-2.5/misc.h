...
extern void slevmar_fdif_forw_jac_approx(void (*func)(float *p, float *hx, int m, int n, double *adata),
					float *p, float *hx, float *hxx, float delta,
					float *jac, int m, int n, double *adata);
extern void dlevmar_fdif_forw_jac_approx(void (*func)(double *p, double *hx, int m, int n, double *adata),
					double *p, double *hx, double *hxx, double delta,
					double *jac, int m, int n, double *adata);

/* central finite differences */
extern void slevmar_fdif_cent_jac_approx(void (*func)(float *p, float *hx, int m, int n, double *adata),
          float *p, float *hxm, float *hxp, float delta,
          float *jac, int m, int n, double *adata);
extern void dlevmar_fdif_cent_jac_approx(void (*func)(double *p, double *hx, int m, int n, double *adata),
