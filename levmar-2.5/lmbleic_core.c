...
struct LMBLEIC_DATA{
  ...
  void (*func)(LM_REAL *p, LM_REAL *hx, int m, int n, double *adata);
  void (*jacf)(LM_REAL *p, LM_REAL *jac, int m, int n, double *adata);
  double *adata;
};


/* wrapper ensuring that the user-supplied function is called with the right number of variables (i.e. m) */
static void LMBLEIC_FUNC(LM_REAL *pext, LM_REAL *hx, int mm, int n, double *adata)
{
...
static void LMBLEIC_JACF(LM_REAL *pext, LM_REAL *jacext, int mm, int n, double *adata)
{
struct LMBLEIC_DATA *data=(struct LMBLEIC_DATA *)adata;
int m;
register int i, j;
...
int LEVMAR_BLIC_DER(
  void (*func)(LM_REAL *p, LM_REAL *hx, int m, int n, double *adata),
  void (*jacf)(LM_REAL *p, LM_REAL *j, int m, int n, double *adata),
  LM_REAL *p, LM_REAL *x, int m, int n,
  LM_REAL *lb, LM_REAL *ub,
  LM_REAL *C, LM_REAL *d, int k2,
  int itmax, LM_REAL opts[4], LM_REAL info[LM_INFO_SZ], LM_REAL *work, LM_REAL *covar, double *adata)
{
...
int LEVMAR_BLIC_DIF(
  ...
  LM_REAL *lb, LM_REAL *ub,
  LM_REAL *C, LM_REAL *d, int k2,
  int itmax, LM_REAL opts[5], LM_REAL info[LM_INFO_SZ], LM_REAL *work, LM_REAL *covar, double *adata)
{
