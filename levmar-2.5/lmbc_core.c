...
LNSRCH(int m, LM_REAL *x, LM_REAL f, LM_REAL *g, LM_REAL *p, LM_REAL alpha, LM_REAL *xpls,
       LM_REAL *ffpls, void (*func)(LM_REAL *p, LM_REAL *hx, int m, int n, double *adata), struct FUNC_STATE state,
...
static void LMBC_DIF_FUNC(LM_REAL *p, LM_REAL *hx, int m, int n, double *data)
{
...
static void LMBC_DIF_JACF(LM_REAL *p, LM_REAL *jac, int m, int n, double *data)
{
struct LMBC_DIF_DATA *dta=(struct LMBC_DIF_DATA *)data;
