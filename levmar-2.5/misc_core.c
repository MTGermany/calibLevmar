...
void LEVMAR_CHKJAC(
    ...
    LM_REAL *p, int m, int n, double *adata, LM_REAL *err)
{
 ...
 */
LM_REAL LEVMAR_R2(void (*func)(LM_REAL *p, LM_REAL *hx, int m, int n, double *adata),
                  LM_REAL *p, LM_REAL *x, int m, int n, double *adata)
{
register int i;
